...
class DeliverablesAnalyzerAdapterTest {
    ...
    void successCallback() {
        ...
        Mockito.verify(callbackEndpoint)
                .succeed(eq(deliverablesAnalyzerAdapter.getRexTaskName(correlationId)), captor.capture(), null);

        assertThat(captor.capture().isSuccess()).isEqualTo(report.isSuccess());
        assertThat(captor.capture().getResults()).isEqualTo(report.getResults());
    }
