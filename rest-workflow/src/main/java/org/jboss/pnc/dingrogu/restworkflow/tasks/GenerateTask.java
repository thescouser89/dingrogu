...
import org.jboss.pnc.dingrogu.restworkflow.workflows.RepositoryCreation;
...
public class GenerateTask {
    ...
    public CreateGraphRequest generateSingleRequest() throws Exception {
        ...
        Map<String, CreateTaskDTO> vertices = Map.of("elvis" + uuid, taskDTO, "charles" + uuid, taskDTOCharles);

        EdgeDTO edgeDTO = EdgeDTO.builder().source("elvis" + uuid).target("charles" + uuid).build();
